...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonControllerMod : MonoBehaviour
    {
        ...
        private void Start()
        {
			...
			handler.GetComponent<MenuHandler> ().enterMenu += EnterMenu;
        ...
        public string GetBlockersAsString()
        {
            string s = "";
            s += "In menu: " + (inMenu ? "\u2713" : "x") + "\n";
            s += "In dialogue: " + (inDialogue ? "\u2713" : "x") + "\n";
            s += "In cutscene: " + (inCutscene ? "\u2713" : "x") + "\n";
            s += "Blocked: " + (blocked ? "\u2713" : "x");
            return s;
        }
        ...
        private void Update()
        {
			...
			if (inDialogue || inMenu || blocked || inCutscene)
            {
                Cursor.visible = true;
