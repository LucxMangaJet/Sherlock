...
public class SaveGameHandler : MonoBehaviour {
    ...
    public void SaveGame()
        {
         ...
         List<CharacterSaveFormat> characters = new List<CharacterSaveFormat>();
            ...
            foreach (GameObject g in charObjects)
            {
              ...
              SaveFile save = new SaveFile(playerPos,playerRot,time,variableKey,variableValue,evidences,characters);
    ...
    public class SaveFile
    {
        ...
        public SaveFile(Vector3 _playerPos, Vector3 _playerRot, float _time, string[] _variableKey, bool[] _variableValue, UnitedEvidence[] _evidences ,List<CharacterSaveFormat> _characters )
        {
