...
public class DialogueParser : MonoBehaviour {
	...
	DialogueOption T_TranslateDialogueIntoDialogueOption (string dial)
	{
		...
		if (debug) {
			...
			if (isEvidence) {
				return new DialogueOption (objEvidence,reqEvidences,lines[2],reqV,setV,(evidences.Count>0)? evidences.ToArray():null);
			}
		return new DialogueOption (lines [1], lines [2], reqV, setV, (evidences.Count>0)? evidences.ToArray():null);
	}
...
public class DialogueOption{
	...
	public DialogueOption(string _question, string _answer, TextBool[] _reqVariables, TextBool[] _SetVariables, TextEvidence[] _evidences){
		reqTB = _reqVariables;
		setTB = _SetVariables;
		question = _question;
		answer = _answer;
	...
	public DialogueOption(bool _ObjEvidence, string[] _reqEvidence, string _answer, TextBool[] _reqVariables, TextBool[] _SetVariables, TextEvidence[] _evidences){
		fromEvidence = true;
		reqTB = _reqVariables;
		setTB = _SetVariables;
